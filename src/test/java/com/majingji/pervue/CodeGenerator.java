...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //数据库连接地址
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/lian7?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
        //驱动类 名称
        ...
        //包含那些表
        strategyConfig.setInclude("lx_goods","lx_goods_sales","lx_sales");
